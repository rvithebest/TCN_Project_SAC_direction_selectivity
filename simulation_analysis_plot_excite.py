...
h.load_file("SAC_excite_simulator.hoc")
...
plt.title("Bar Moving from right to left- Differential excitation (temporally) with Kv3 gradient", fontsize=16)
...
plt.ylim(-70, 30)
plt.suptitle("Bar Moving from right to left -Differential excitation (temporally) with Kv3 gradient", fontsize=16)
...
plt.xlabel("Time (ms)", fontsize=15)
plt.ylabel("Membrane Potential (mV)", fontsize=15)
plt.title("Voltage Traces (Bar Moving from left to right)- Differential excitation (temporally) with Kv3 gradient", fontsize=16)
...
# All the y-axis range- shoubld be same- -70 to +20
plt.ylim(-70, 30)
plt.suptitle("Bar Moving from left to right- Differential excitation (temporally) with Kv3 gradient", fontsize=16)
