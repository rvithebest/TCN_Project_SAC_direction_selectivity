...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 Kv31 /Users/rajuiyer/Desktop/TCN_Project/Kv31.mod\n");
 ...
 v=_v;
{
  ...
  ek = _ion_ek;
 { error =  states();
 if(error){fprintf(stderr,"at line 64 in file Kv31.mod:\n	SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/rajuiyer/Desktop/TCN_Project/Kv31.mod";
static const char* nmodl_file_text = 
